...
void WavePatternsEffect::process(cv::Mat& out_bgr, int target_width, int target_height) {
    ...
    cv::resize(proc_frame, out_bgr, cv::Size(output_width, output_height), 0, 0, cv::INTER_LINEAR);
}
